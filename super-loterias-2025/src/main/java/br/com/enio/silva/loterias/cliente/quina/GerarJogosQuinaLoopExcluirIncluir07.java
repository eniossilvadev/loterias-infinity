...
import br.com.enio.silva.loterias.config.quina.QuinaConfig07;
...
public class GerarJogosQuinaLoopExcluirIncluir07 extends Base {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int count = 0; count < totalDeJogos; count++) {
			...
			QuinaConfigAb config = new QuinaConfig07();
