...
public class QuinaComBaseMovel extends GerarJogosQuinaBingoAb {

	public static void main(String[] args) throws IOException {

		final int totalDeJogos = 1;

		final int qttInicialFixo = 50000;
		...
		List<Integer> theList = Arrays.asList(4,8,17,22,25,32,49,51,70,78);
