...
public class PontuadorMega9 extends PontuadorBasico {

	public PontuadorMega9() {
		super();

		mapPontos.put(0, -1);
		mapPontos.put(1, 1);
		mapPontos.put(2, 4);
		mapPontos.put(3, (int) Math.pow(2, 6));
		mapPontos.put(4, (int) Math.pow(2, 10));
		mapPontos.put(5, (int) Math.pow(2, 12));
		mapPontos.put(6, -1000000);
	}
