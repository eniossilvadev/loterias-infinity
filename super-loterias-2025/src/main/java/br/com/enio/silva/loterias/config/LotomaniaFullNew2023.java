...
public class LotomaniaFullNew2023 extends GerarJogosLotofacil2020Ab {
	...
	public static List<List<Integer>> execute(final int times, final int defaultSize, Config conf)
		...
		List<List<Integer>> full = LotoUtils.getAll("C:\\loterias\\gerador-apostas\\lotofacil\\curr", defaultSize);
