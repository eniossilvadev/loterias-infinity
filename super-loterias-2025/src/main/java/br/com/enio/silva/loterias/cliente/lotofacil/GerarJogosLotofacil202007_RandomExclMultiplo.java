...
public class GerarJogosLotofacil202007_RandomExclMultiplo extends GerarJogosLotofacil2020Ab {
	...
	// 1, 2, 3, 4, 5, 6
	// 20, 21, 22, 23, 24, 25
	public static List<Integer> listaSelExclusaoMin = Arrays.asList(1, 2, 3, 22, 23, 24, 25);

	public static List<Integer> listaSelExclusaoMax = Arrays.asList(1, 2, 3, 5, 23, 24, 25);

	public static List<Integer> listaSelExclusaoMix = Arrays.asList(1, 2, 3, 4, 22, 23, 24, 25);

	public static List<Integer> listaSelExclusao = Arrays.asList();
	...
	public static void main(String[] args) throws IOException {
		...
		for (int count = 0; count < total; count++) {
			...
			int result = curr % 3;
			if (result == 0) {
				listaSelExclusao = listaSelExclusaoMix;
			} else if (result == 1) {
				listaSelExclusao = listaSelExclusaoMin;
			} else {
				listaSelExclusao = listaSelExclusaoMax;
			}
