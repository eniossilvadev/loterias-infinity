...
public class GerarLotofacilUltimoSorteio extends GerarJogosLotofacil2020Ab {

	private static final int qttInicial = 125000;
	...
	public static final int ultimos = -1;

	public static final int sequenciaMaxima = 9;

	public static final int tamPadraoExcluir = 2;

	public static final int tamPadraoIncluir = 1;
	...
	public static void main(String[] args) throws IOException {
		...
		List<Integer> last = new ArrayList<>(getLast(listaJogosCorrentes));
		...
		for (int count = 0; count < total; count++) {
			...
			try {
				...
				Set<Integer> listaIncl = ListaUtils.getFromList(last, tamPadraoIncluir);
				Set<Integer> listaExcl = ListaUtils.getFromList(last, tamPadraoExcluir);
				...
				last.addAll(listaIncl);
				preJogos = aplicarFiltroUltimoSorteio(last, preJogos, minimo, maximo);
