...
public class GerarJogosQuinaLoopExcluirIncluirQuadranteFiltroFixo extends Base {
	...
	public static void main(String[] args) throws IOException {
		...
		List<Integer> listaBase = Arrays.asList(1,5,17,25,41,49,54,57,58,76); // importante
		int maxListaBase = 8;
