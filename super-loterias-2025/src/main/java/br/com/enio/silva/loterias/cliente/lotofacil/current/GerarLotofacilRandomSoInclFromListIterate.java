...
public class GerarLotofacilRandomSoInclFromListIterate extends GerarJogosLotofacil2020Ab {
	...
	public static int tamPadraoIncluir = 0;
	...
	public static void main(String[] args) throws IOException {
		...
		for (int count = 0; count < size; count++) {
			...
			try {
				...
				// tamPadraoIncluir = 5 + count % 10;
				tamPadraoIncluir = 12 + count % 3;
