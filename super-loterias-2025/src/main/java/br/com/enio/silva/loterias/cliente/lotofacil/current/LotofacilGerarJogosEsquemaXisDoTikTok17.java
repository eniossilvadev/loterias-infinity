...
public class LotofacilGerarJogosEsquemaXisDoTikTok17 extends GerarLotofacilModular {

	private static int qttInicial = 200; // vezes 252

	public static int total = 1; // número de apostas criadas
	...
	public static void main(String[] args) throws IOException {
		...
		List<List<Integer>> resultados = config.obterTodosResultados();
		...
		for (int count = 0; count < total; count++) {
			...
			try {
				...
				List<List<Integer>> preJogos = EsquemasLotofacilUtil
						.gerarJogosIniciaisEstrategiaXdoTikTok17(qttInicial);
