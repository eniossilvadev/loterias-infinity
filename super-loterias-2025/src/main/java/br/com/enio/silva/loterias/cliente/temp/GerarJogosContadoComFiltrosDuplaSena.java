...
public class GerarJogosContadoComFiltrosDuplaSena {
	...
	public static void main(String[] args) throws IOException {
		...
		String path = ConstantesUtil.DUPLA_SENA_CAMINHO_DOWNLOAD + "RESULTADO_DS2.txt";
		List<List<Integer>> resultados = GerarListaDuplaSena.getInstance()
		        .gerarArquivoResultado(path);

		Set<Integer> set = new HashSet<Integer>(Arrays.asList(4, 14, 18, 36, 39, 42, 45, 3, 8, 14,
		        24, 25, 39, 42, 3, 8, 12, 19, 25, 46, 47));
