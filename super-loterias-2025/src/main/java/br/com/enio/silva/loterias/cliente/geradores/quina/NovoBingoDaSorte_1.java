...
public class NovoBingoDaSorte_1 extends GerarJogosQuinaBingoAb {

	public static void main(String[] args) throws IOException {

		final int qttInicialFixo = 150000;
		final int qttOriginal = qttInicialFixo;

		final int tamPadraoExcluir = 10;
		final int defaultSize = 5;
		final int tamanhoBaseMovel = 7;

		QuinaConfigAb config = new QuinaConfig10();

		// https://www.mazusoft.com.br/quina/tabela-sequencia-atraso.php
		List<List<Integer>> theLists = ArquivoUtil
				.obterLinhasComoListasUnique("C:\\loterias\\auxiliar\\bs_base.txt");
		...
		//		QuinaConfigAb config = new QuinaConfig6_1();
		...
		for (List<Integer> theList: theLists) {
			...
			try {
				...
				Set<Integer> listaInclFixa = new HashSet<>(ListaUtils.getElements(1, 80, tamanhoBaseMovel));
...
//					ArquivoUtil.save(mc, CaminhoResultados.QUINA.getBasePath() + "correntes2.txt");
//
...
//					ArquivoUtil.save(ma, CaminhoResultados.QUINA.getBasePath() + "atuais2.txt");
