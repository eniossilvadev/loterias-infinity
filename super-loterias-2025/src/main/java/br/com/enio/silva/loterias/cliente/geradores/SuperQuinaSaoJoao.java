 ...
 *
 */
public class SuperQuinaSaoJoao extends Base {
	...
	public static final String CONFIG_PATH = "E:\\loterias\\sao-joao\\config\\";

	public static final String CURR_PATH = "E:\\loterias\\sao-joao\\curr\\";
	...
	public static List<List<Integer>> execute(final int totalDeJogos, final int maxListaBase,
		...
		String fileName = "E:\\loterias\\sao-joao\\curr\\vip.txt";
