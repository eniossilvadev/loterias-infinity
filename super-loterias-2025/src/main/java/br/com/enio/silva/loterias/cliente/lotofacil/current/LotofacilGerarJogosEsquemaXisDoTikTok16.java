...
public class LotofacilGerarJogosEsquemaXisDoTikTok16 extends GerarLotofacilModular {

	private static int qttInicial = 200; // vezes 252

	public static int total = 2; // número de apostas criadas
		...
		for (int count = 0; count < total; count++) {
			...
			try {
				...
				List<List<Integer>> preJogos = EsquemasLotofacilUtil
						.gerarJogosIniciaisEstrategiaXdoTikTok16(qttInicial);
