...
public class GerarJogosMegaLoopExcluirIncluirTopezaUltimos extends GerarJogosMegaLoopAb {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int count = 0; count < totalDeJogos; count++) {
			...
			try {
				...
				tamPadraoIncluir = 4 - var1 % 4;
				tamPadraoExcluir = 10 + var2 % 20;
				...
				if (qttInicialFixo < 0) {
					...
					if (mod2 == 0) {
						qttInicialFixo = 150000 / 2;
					} else if (mod3 == 1) {
						qttInicialFixo = 126000 / 2;
					} else {
						qttInicialFixo = 175000 / 2;
					}
				}
