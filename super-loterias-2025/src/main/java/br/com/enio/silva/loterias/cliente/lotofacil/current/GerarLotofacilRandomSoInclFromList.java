...
public class GerarLotofacilRandomSoInclFromList extends GerarJogosLotofacil2020Ab {
	...
	public static int maximoInicio = 9;

	public static int minimoFim = 19;

	public static int tamIncluir = 11;
	...
	public static void main(String[] args) throws IOException {
		...
		String li = base + "LI.txt";

		List<List<Integer>> listasInclusao = new LinkedList<>(
				ArquivoUtil.obterLinhasComoListas(li));

		ArquivoUtil.saveLists(listasInclusao, li, "\t", 2);

		for (int count = 0; count < listasInclusao.size(); count++) {
