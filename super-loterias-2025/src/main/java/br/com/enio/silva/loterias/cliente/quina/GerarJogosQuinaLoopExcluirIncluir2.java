...
public class GerarJogosQuinaLoopExcluirIncluir2 extends Base {
	...
	public static void main(String[] args) throws IOException {
		...
		String listaExternaPath = "C:\\loterias\\gerador-apostas\\quina\\config\\incluir.txt";
		List<List<Integer>> listaExternaIncluir = ArquivoUtil
		        .obterLinhasComoListasUnique(listaExternaPath);

		int count = -1;
		for (List<Integer> theIncludeList : listaExternaIncluir) {
			...
			try {
				...
				Set<Integer> listaIncl = new HashSet<>(theIncludeList);
				System.out.println(repeated50);
