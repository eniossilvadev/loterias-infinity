...
public class GerarJogosLotofacilNovoLoopFromFilePy {
	...
	public static List<List<Integer>> filtroMaximoInicio(int maximoInicio,
	...
	public static List<List<Integer>> filtroMinimoFim(int minimoFim, List<List<Integer>> full) {
	...
	public static void main(String[] args) throws IOException {
		...
		List<List<Integer>> fullList = ArquivoUtil.obterLinhasComoListas(combinacoes);
		...
		int maximoInicio = 3;
		fullList = filtroMaximoInicio(maximoInicio, fullList);

		int minimoFim = 23;
		fullList = filtroMinimoFim(minimoFim, fullList);
