...
import br.com.enio.silva.loterias.config.megasena.MegaSenaConfigSuper08;
...
public class MegaLoopExcluirIncluirTopezaSuper08 extends GerarJogosMegaLoopAb {

	public static void main(String[] args) throws IOException {

		SaveMegaSena saveMegaSena = new SaveMegaSena();

		final int totalDeJogos = 2;

		int qttInicialFixo = 20000;
		final int qttOriginal = qttInicialFixo;

		int tamPadraoExcluir = 10;
		int tamPadraoIncluir = 4;

		final int defaultSize = 6;

		MegaSenaConfigAb config = new MegaSenaConfigSuper08();
